...
def vote_by_county(candidate):
	...
	votefrac_df = votefrac_df[votefrac_df.candidate == candidate]
	...
	vis.legend(title=candidate + ' Vote Share')
	vis.to_json('vega.json', html_out = True, html_path='bar_template.html')
	
if __name__ == '__main__':
	vote_by_county('Hillary Clinton')
